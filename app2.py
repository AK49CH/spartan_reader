...
#Slider to control the number of topics for the summary

num_topics = st.slider("Use The Slider To Select The Number of Topics Your Summary Should Contain:", 1, 5, 3)

st.write("Topic Length", num_topics)  
